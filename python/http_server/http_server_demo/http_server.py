...
class myHandler(BaseHTTPRequestHandler):
  ...
  def do_POST(self):
    ...
    #print form结果：
    # FieldStorage(None, None, [MiniFieldStorage('test', 'testvalue'), MiniFieldStorage('name', 'Maximus'), MiniFieldStorage('addr', 'GZ')])
    #print form.getlist("name")结果
    #['Maximus']


    #存储一些信息到yyyy-m-dd-hh-mm-ss.log文件
...
#获取当前时间yyyy-m-dd-hh-mm-ss，例如2015-4-21-16-10-57
